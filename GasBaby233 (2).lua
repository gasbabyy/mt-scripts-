...
-- ADMIN GUN
-- ============================================================
local adminGunTool = nil
local function createAdminGun()
    pcall(function()
        if adminGunTool and adminGunTool.Parent then adminGunTool:Destroy() end
        local tool = Instance.new("Tool")
        tool.Name = "☀ AdminRGB"
        tool.RequiresHandle = true
        tool.ToolTip = "GasBaby233 Admin Gun"
        ...
        -- RGB loop on handle
        task.spawn(function()
            while adminGunTool and adminGunTool.Parent do
                pcall(function() handle.Color = rgb() end)
                task.wait(0.05)
            end
        end)
...
local function removeAdminGun()
    if adminGunTool then
        pcall(function() adminGunTool:Destroy() end)
        adminGunTool = nil
    end
end
